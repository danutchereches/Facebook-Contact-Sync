...
public class Security {
	...
	public static boolean verifyPurchase(String base64PublicKey,
		 ...
		 * TextUtils.isEmpty(base64PublicKey) || TextUtils.isEmpty(signature)) {
		 * Log.e(TAG, "Purchaxse verification failed: missing data."); return
		 * false; }
		 * 
		 * PublicKey key = Security.generatePublicKey(base64PublicKey); return
		 * Security.verify(key, signedData, signature);
		 */
	}
